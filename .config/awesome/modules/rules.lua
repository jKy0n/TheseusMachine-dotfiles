...
--
...

	{
		...
		properties = { floating = false, placement = awful.placement.centered, tag = screen[3].tags[3] },
	},
...
--
	{
		...
		properties = { floating = true, placement = awful.placement.centered, tag = screen[3].tags[1] },
	},
...
--
...

	{
		...
		properties = { floating = false, tag = screen[1].tags[5] },
	},
...
--
	...
	{ rule = { class = "Thunar" }, properties = { floating = true, placement = awful.placement.centered } },

	{
		rule = { class = "thunderbird" },
		properties = { floating = false, placement = awful.placement.left, tag = screen[1].tags[4] },
	},
